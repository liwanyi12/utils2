...
namespace Liwanyi\Utils2\Pay\Gateways;
...
use Liwanyi\Utils2\Pay\Contracts\HttpService;
...
abstract class Alipay extends GatewayInterface
{
    ...
    {
        $html = "<form id='alipaysubmit' name='alipaysubmit' action='{$this->gateway}' method='post' target='_blank'>";
